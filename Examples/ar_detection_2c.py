...
fnames={}
for exp,exn in zip(experiments[1:2],exnames[1:2]):
    fnames[exn]={}
    for vn in var_names:
...
ivtfiles = sorted(glob(ivt_folder+'*.2c.*.nc'))[:20]
pptfiles = fnames['2xCO2']

outfolder = '/proj/arjun/CESM/Atmosp_Rivers/SCAFEX_V1/2xCO2/'
